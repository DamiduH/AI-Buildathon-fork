    ...
    >
      ...
      <div className="hero-banner-container" style={{ zIndex: 0 }}>
        <img
          ...
          alt="Orange gradient grid background for the AI Buildathon"
        />
      </div>
      <span
        className="badge"
      ...
      <h1
        ...
        aria-label="AI Buildathon"
        style={{ zIndex: 2, position: "relative" }}
      >
        <span
          className="hero-title-main hero-title-desktop-ai"
          ref={titleMainRef}
          aria-hidden="true"
        >
          AI
        </span>{" "}
        <span className="gradient-text hero-title-desktop-word">
          Buildathon.
        </span>
        <span className="hero-title-mobile-ai" aria-hidden="true">
          AI
        </span>
        <span className="hero-title-mobile-word" aria-hidden="true">
          <span>Build-</span>
          <span>athon.</span>
        </span>
      </h1>
      ...
      >
        Join the AI Buildathon and turn your ideas into real-world solutions.
