  ...
  return (
    <section className="toolkit" id="tools">
      <div
        ...
        className="reveal"
      >
        <span className="section-label">YOUR AI TOOLKIT</span>
        <h2 className="section-title" style={{ marginBottom: "1.25rem" }}>
          Three Tools. <br className="mobile-title-break" />
          One Mission: Build.
        </h2>
        <p
          style={{
        ...
        >
          Meet the tools that will power your journey from first idea to final
          prototype.
        </p>
      </div>
      ...
      <div className="toolkit-grid">
        ...
        <div className="tool-card reveal stagger-1">
          ...
          <div className="tool-body">
            <p>
              An AI-native development environment designed to help you turn
              ideas and specifications into working software.
            </p>
        ...
        <div className="tool-card reveal stagger-2">
          ...
          >
            <svg viewBox="0 0 240 100" width="100%" height="100%">
              <g transform="translate(15, 15)">
                ...
                />
                <path
                  d="M 75 30 L 70 27 M 75 30 L 70 33"
                  stroke="var(--text-muted)"
                  strokeWidth="1.5"
                />
                ...
                />
                <path
                  d="M 150 30 L 145 27 M 150 30 L 145 33"
                  stroke="var(--text-muted)"
                  strokeWidth="1.5"
                />
                ...
                <path
                  d="M 25 45 C 25 65, 177 65, 177 45"
                  fill="none"
                  stroke="var(--primary-orange)"
                  strokeWidth="1.5"
                />
          ...
          <div className="tool-body">
            <p>
              Describe what you need and let an AI agent help plan, execute and
        ...
        <div className="tool-card reveal stagger-3">
          ...
          <div className="tool-body">
            <p>
              Connect models, APIs and data to create AI-powered workflows that
              can be triggered, automated and shared.
            </p>
